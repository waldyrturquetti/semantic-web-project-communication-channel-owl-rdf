...
class GetAllCommChannelsAndCommResourcesByUser(object):
    get_all_comm_channels_and_comm_resources_by_user = (
        graphene.List(CommChannelsAndCommResourcesDto, user_name=graphene.String()))

    def resolve_get_all_comm_channels_and_comm_resources_by_user(self, info, user_name):
        query_result = comm_channel_repository.get_all_comm_channels_and_comm_resources_by_user(user_name)
